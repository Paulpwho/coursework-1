...
def only_green(image_list):
    ...
    print(image_list)
    for i in range(len(image_list)):
        image_list[i][::2] = [0, 0] #::2 = 0:3:2 = select elements 0 to 2, skip 2 elements, replace with 0
...
if __name__ == "__main__":
    ...
    if menu_choice == 1:
        image_list = greyscale(image_list)
    elif menu_choice == 2:
        image_list = only_red(image_list)
    elif menu_choice == 3:
        image_list = only_green(image_list)
    elif menu_choice == 4:
        image_list = only_blue(image_list)
    elif menu_choice == 5:
        image_list = negative_green(image_list)
    elif menu_choice == 6:
